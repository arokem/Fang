...
params.stimParams.adaptTilt=45; 
...
params.HID.device=4; % 4= jong_laptop; 5=The Targus numpad; 3=keyboard (but need to change stuff in the getResponse, if you use the keyboard!)

params.HID.deviceEyeMotion=0; %3 for keyboard; 0 for no eye motion monitoring

%////Quest params:\\\

params.questParams.QuestCGuess=0.5;
